function AuthLayout({ children }) {
  return (
    <div className="relative h-screen overflow-hidden">
      <div className="absolute inset-0 bg-[url(/public/images/background.jpg)] bg-no-repeat bg-center bg-cover blur-xs scale-110" />
      <div className="absolute inset-0 bg-font-primary/65" />
